...
var Clip = function (_EventEmitter) {
    ...
    _createClass(Clip, [{
        ...
        value: function update(time) {
            ...
            this.emit(_define.Ev.UPDATE, progress, attr, elapsed);
        ...
        value: function _afterUpdate(time, elapsed) {
            ...
            if (elapsed === 1) {
                ...
                if (repeat > 1) {
                    ...
                    this.emit(_define.Ev.REPEAT_COMPLETE, repeat);
                    this.emit(_define.Ev.REPEAT, repeat_0 - repeat);
                    ...
                    if (repeat_0 > 1) {
                        this.emit(_define.Ev.REPEAT_COMPLETE, 0);
                    }
