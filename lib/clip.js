    ...
    _createClass(Clip, [{
        ...
        value: function start(force) {
            ...
            if (repeat > 1 && repeat === this._repeat_0 && onceRepeat) {
                this.emit(_define.Ev.REPEAT, { remain: 0 });
            }
        ...
        value: function update(time) {
            ...
            this.emit(_define.Ev.UPDATE, { progress: progress, keyframe: keyframe, elapsed: elapsed });
        ...
        value: function _afterUpdate(time, elapsed) {
            ...
            if (elapsed === 1) {
                ...
                if (repeat > 1) {
                    ...
                    this.emit(_define.Ev.REPEAT_COMPLETE, { repeat: repeat });
                    this.emit(_define.Ev.REPEAT, { remain: repeat_0 - repeat });
                    ...
                    if (repeat_0 > 1) {
                        this.emit(_define.Ev.REPEAT_COMPLETE, { repeat: 0 });
                    }
