...
var plugin = {
  ...
  test: function test(value, key) {
    return _colorhelper["default"].isColor(value);
  },
  ...
  parse: function parse(value, key) {
    return _colorhelper["default"].toNormalArray(value);
  },
  ...
  valueOf: function valueOf(parsedValue, progress, elapsed, key) {
    var val = _colorhelper["default"].linearGradient(parsedValue, progress);

    val = _colorhelper["default"].toRGBA(val);
    return val;
  }
};
