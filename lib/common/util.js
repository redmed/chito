...
function normalize(arr) {
    ...
    var _options$type = options.type,
        ...
        range = _options$range === undefined ? [0, 1] : _options$range,
        _options$min = options.min,
        min = _options$min === undefined ? Math.min.apply(Math, arr) : _options$min,
        _options$max = options.max,
        max = _options$max === undefined ? Math.max.apply(Math, arr) : _options$max;
